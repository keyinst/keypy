...
class Test_a_mstates_preprocessing_test2(unittest.TestCase):
    def test_a_mstates_preprocessing_test2(self):
        ###########################
        ### Run Study Info File ###
        ###########################
        ...
        inputfolder = os.path.join(library_path, "..","data","test2")
