...
class Test_a_mstates_preprocessing_test1(unittest.TestCase):
    def test_a_mstates_preprocessing_test1(self):
        ###########################
        ### Run Study Info File ###
        ###########################
        ...
        outputfolder = os.path.join(library_path, "..","data","test1_output")
