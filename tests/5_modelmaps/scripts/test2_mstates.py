...
#############################################################
# test2_mstates.py computes one modelmap output at a time ###
#############################################################
...
class Test_test2_mstates(unittest.TestCase):
    def test2_mstates(self):
        ...
        outputfolder = os.path.join(library_path, "..","data","test2_output")
        ...
        ############
        # Compute modelmaps: One input hdf and one output hdf
        ############
        ...
        #'means across conds for each group'
