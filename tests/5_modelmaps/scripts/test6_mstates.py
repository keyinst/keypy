...
###############################################################
# test6_mstates.py computes a series of modelmaps at a time ###
###############################################################
...
class Test_test6_mstates(unittest.TestCase):
    def test6_mstates(self):
        ################################
        ...
        outputfolder = os.path.join(library_path, "..","data","test6_output")
